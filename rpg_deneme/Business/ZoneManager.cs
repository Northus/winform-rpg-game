...
public class ZoneManager
{
    ...
    public bool CanEnterDifficulty(int charId, int zoneId, Enums.ZoneDifficulty diff)
    {
        ...
        return diff switch
        {
            Enums.ZoneDifficulty.Normal => _repo.GetBossKilled(charId, zoneId, Enums.ZoneDifficulty.Easy),
            Enums.ZoneDifficulty.Hard => _repo.GetBossKilled(charId, zoneId, Enums.ZoneDifficulty.Normal),
            _ => false,
        };
    }
